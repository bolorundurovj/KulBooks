...
<html lang="en">
<head>
    <title>Code coverage report for spud/lib/serializer/properties/reader.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">spud/lib/serializer/properties/reader.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">spud/lib/serializer/properties/</a> &#187; reader.js</div>
</div>
<div class="body">
					...
					if ( arrMap[2] !== '' ) {
						...
						arrMap[2].split(/\]\[/).forEach(function (arrProp, arrIndex, subArr) {
							...
							if ( arrProp.match(/^[0-9]+$/) ) {
								...
								if ( arrIndex === 0 ) {
									tail = tail[arrKey] = (typeof tail[arrKey] !== 'undefined' &amp;&amp; typeof tail[arrKey] === 'object') ? tail[arrKey] : <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
								}
								// Assign the value if it's the last key in the set
								tail[arrProp] = ( arrIndex === subArr.length - 1 ) ? value : tail[arrProp] || {};
							}
