...
<html lang="en">
<head>
    <title>Code coverage report for spud/lib/transcoder.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">spud/lib/transcoder.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">spud/lib/</a> &#187; transcoder.js</div>
</div>
<div class="body">
        ...
        function handle(out) {
            if (typeof out === 'function') {
                src.pipe(bl(function (err, data) {
                    out(err, data ? data.toString('utf-8') : <span class="branch-1 cbranch-no" title="branch not covered" >data)</span>;
                }));
            } else if (out) {
                src.pipe(out);
            } else {
...
function splitError(errcb, retcb) {
	return function (err, data) {
		<span class="missing-if-branch" title="if path not taken" >I</span>if (err) {
<span class="cstat-no" title="statement not covered" >			return errcb(err);</span>
		} else {
			return retcb(data);
		}
	};
...
&nbsp;
    function mergeOtherFiles(data, callback) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!source.path) {
<span class="cstat-no" title="statement not covered" >            return callback(new Error("Includes can only be used in streams from files"));</span>
        }
